      ...
      <div className="text-center">
          ...
          <ul className="navbar mt-5 flex flex-row justify-center text-xl font-medium text-gray-800">
            ...
            <li className="mx-4">
              <a
                className="link-hover link text-[#4A4A4A]"
                target="_blank"
                href="https://rooch.network/learn/welcome"
              >
                Rooch Learn
              </a>
            </li>
            <li className="mx-4">
              <a
                className="link-hover link text-[#4A4A4A]"
                target="_blank"
                href="https://github.com/rooch-network/rooch/tree/main/sdk/typescript/rooch-sdk"
              >
                Rooch SDK
              </a>
            </li>
        ...
        <div className="mt-8 flex justify-center">
          <div className="footer-icon-list flex flex-wrap">
            <a href="/" className="mr-3 text-gray-500 hover:text-gray-700">
              <svg
        ...
        <div className="mt-8 text-sm">
          <div className="footer-copyright">
            ...
            <a
              ...
              href="https://github.com/nlyrthiia/Rooch-Dapp-Template"
            >
              Rooch Dapp Teamplate
            </a>
            .
          </div>
        </div>
